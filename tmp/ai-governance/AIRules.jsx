  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">AI Usage Rules</h2>
          <p className="text-gray-600 mt-1">Configure AI usage policies and restrictions</p>
        </div>
        <Button
          onClick={() => {
            setEditingRule(null);
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${rule.allowed ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
