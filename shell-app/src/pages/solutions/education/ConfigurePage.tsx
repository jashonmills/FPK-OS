...
const productCatalog: Product[] = [
  {
    id: "aegis",
    name: "FPK Aegis Governance Layer",
    description: "Standalone AI safety, compliance, and data privacy layer.",
    pricingModel: "usage",
    pricePerUnit: 150,
    unit: "GB processed",
    category: "Foundation",
    ...
    includedFeatures: [
      "AI content moderation (CIPA aligned)",
  ...
  },
  {
    id: "university",
    name: "FPK University",
    description: "Adaptive learning and curriculum management suite.",
  ...
  },
  {
    id: "pulse",
    name: "FPK Pulse",
    description: "Internal operations and project management suite.",
    pricingModel: "per_seat",
    pricePerSeat: 10,
    category: "Applications",
  ...
  },
  {
    id: "nexus",
    name: "FPK Nexus",
    description: "Private, moderated social community hub.",
    pricingModel: "per_seat",
    pricePerSeat: 5,
    category: "Applications",
  ...
  },
  {
    id: "sis",
    name: "Integrated SIS",
    description: "Admissions, enrollment, and student records.",
    pricingModel: "per_seat",
    pricePerSeat: 8,
    category: "Applications",
  ...
  },
  {
    ...
    description: "Behavioral and learning data intelligence platform.",
    pricingModel: "per_seat",
    pricePerSeat: 15,
    category: "Applications",
    icon: <Bot className="h-6 w-6" />,
    includedFeatures: [
      "Behavior & skill tracking",
      "FBA wizards",
      "Session note generation",
      "27 specialized chart types",
    ],
  },
  {
    id: "study_coach",
    name: "AI Study Coach",
    description: "Personalized Socratic assistant for students.",
    pricingModel: "per_seat",
    pricePerSeat: 5,
    category: "Features",
    dependency: "university",
    icon: <ListChecks className="h-6 w-6" />,
    includedFeatures: [
      "24/7 Socratic dialogue partner",
  ...
  {
    id: "lms_integration",
    name: "LMS Integration Pack",
    description: "Connect with Canvas, Blackboard, and more.",
    pricingModel: "per_seat",
    pricePerSeat: 2,
    category: "Features",
    dependency: "university",
    ...
    includedFeatures: [
      ...
      "Roster import",
      "SSO from LMS",
      "FPK content embedding",
    ],
  },
  {
    id: "billing_automation",
    name: "Insurance Billing Automation",
    description: "Automate billing code generation for clinical data.",
    pricingModel: "per_seat",
    pricePerSeat: 5,
    category: "Features",
    dependency: "x",
...
const presetPackages: PresetPackage[] = [
  {
    id: "k12",
    name: "K-12 Essentials",
    description: "Core tools for modern schools.",
    products: ["university", "sis"],
    seats: 1000,
  },
  {
    id: "higher_ed",
    name: "Higher-Ed Suite",
    description: "For university-level instruction and operations.",
    products: ["university", "pulse"],
    seats: 5000,
  },
  {
    id: "community",
    name: "Community Engagement Suite",
    description: "Perfect for learning and connection.",
    products: ["university", "nexus"],
    seats: 2000,
  },
  {
    id: "safety_starter",
    name: "Safety & Compliance Starter",
    description: "High-value, low-risk entry point.",
    products: ["aegis", "study_coach", "university"],
    seats: 500,
  },
  {
    id: "district_os",
    name: "All-in-One District OS",
    description: "Complete FPK ecosystem.",
    products: ["aegis", "university", "pulse", "nexus", "sis", "x"],
    seats: 10000,
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="mb-14 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
            Compose Your Institution&apos;s OS
          </h1>
          <p className="mt-4 mx-auto max-w-2xl text-lg text-slate-600">
            Start from a curated package or compose your perfect stack from our catalog.
          </p>
        </div>
              ...
              <div className="space-y-6 px-6 py-5">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-slate-800">
                    Number of Seats (Students/Faculty)
                  </label>
                  <input
                    id="seats"
                    type="number"
