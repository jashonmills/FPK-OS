      ...
      <nav className="max-w-7xl mx-auto px-6 flex justify-between items-center h-16">
        ...
        <ul className="hidden md:flex items-center gap-8">
          ...
          <li className="group relative">
            <button className="flex items-center gap-1 text-sm font-medium hover:text-indigo-600">
              Products <ChevronDown className="h-4 w-4 transition-transform group-hover:rotate-180" />
            </button>
            <div className="absolute top-full left-0 mt-2 w-72 bg-white border rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity invisible group-hover:visible">
