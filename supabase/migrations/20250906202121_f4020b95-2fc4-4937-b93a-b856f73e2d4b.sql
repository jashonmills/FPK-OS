...
-- Create new non-recursive policies for org_members using SECURITY DEFINER functions
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS %I ON public.organizations', pol_name);
    END LOOP;
END
$$;
