-- Create quiz items for Lesson 1 quizzes
...
SELECT 
  ...
  '{"correct_answer": "b", "explanation": "Opportunity cost is specifically the foregone benefit of the next best alternative - what you give up when you make a choice."}',
  10,
  1,
  now()
...
UNION ALL SELECT 
  ...
  '{"correct_answer": "b", "explanation": "3 hours × €12/hour = €36 in foregone wages. This is what you gave up to study."}',
  10,
  2,
  now()
...
UNION ALL SELECT 
  ...
  '{"correct_answer": "b", "explanation": "Points on the PPC represent efficiency because all resources are being used optimally to produce the maximum possible output."}',
  10,
  1,
  now()
...
UNION ALL SELECT 
  ...
  '{"correct_answers": ["a", "c", "e"], "explanation": "Rational decision-making involves comparing marginal benefits to costs, considering opportunity costs, and thinking at the margin about additional units."}',
  15,
  2,
  now()
...
UNION ALL SELECT 
  ...
  '{"correct_answer": "b", "explanation": "Secure property rights give people confidence that they can keep the benefits of their investments and hard work, encouraging economic activity."}',
  10,
  3,
  now();