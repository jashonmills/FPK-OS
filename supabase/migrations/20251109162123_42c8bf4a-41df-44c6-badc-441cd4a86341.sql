-- Fix get_student_knowledge_pack to use correct column names
...
BEGIN
  -- 1. LEARNING STYLE & PREFERENCES - Use learning_styles array instead of preferences
  ...
  -- 8. RECENT STRUGGLES - Explicitly qualify created_at column
  SELECT jsonb_agg(
    jsonb_build_object(
