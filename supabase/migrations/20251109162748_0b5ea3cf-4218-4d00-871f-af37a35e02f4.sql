-- Fix get_student_knowledge_pack to use correct column name 'progress' instead of 'progress_percentage'
...
BEGIN
  ...
  -- 3. LEARNING GOALS - Use 'progress' not 'progress_percentage'
  SELECT jsonb_agg(
    jsonb_build_object(
      'goal', title,
      'progress', progress,
