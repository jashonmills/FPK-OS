-- Step 1 Final: Fix Security Definer Views - Convert to Security Invoker

-- Drop and recreate scorm_latest_attempt view with SECURITY INVOKER
DROP VIEW IF EXISTS public.scorm_latest_attempt;
...
-- Drop and recreate scorm_learner_progress view with SECURITY INVOKER  
DROP VIEW IF EXISTS public.scorm_learner_progress;
...
-- Drop and recreate scorm_package_metrics view with SECURITY INVOKER
DROP VIEW IF EXISTS public.scorm_package_metrics;  
