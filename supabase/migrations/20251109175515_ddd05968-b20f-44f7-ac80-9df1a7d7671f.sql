-- ================================================================
-- FINAL FIX: Remove ALL non-existent column references
-- ================================================================
-- interactive_course_enrollments only has these columns:
-- id, user_id, course_id, course_title, enrolled_at, last_accessed_at,
-- completion_percentage, completed_at, total_time_spent_minutes, created_at, updated_at, org_id
