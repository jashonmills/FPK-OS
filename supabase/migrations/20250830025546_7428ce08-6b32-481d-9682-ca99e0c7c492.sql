-- =========================================================
-- SCORM Studio: Production-ready database schema
...
CREATE TABLE IF NOT EXISTS scorm_analytics (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS scorm_logs (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  enrollment_id UUID REFERENCES scorm_enrollments(id) ON DELETE SET NULL,
  sco_id UUID REFERENCES scorm_scos(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS scorm_rate_limits (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE INDEX IF NOT EXISTS idx_scorm_packages_owner ON scorm_packages(created_by);
CREATE INDEX IF NOT EXISTS idx_scorm_packages_status ON scorm_packages(status);
CREATE INDEX IF NOT EXISTS idx_scorm_packages_public ON scorm_packages(is_public) WHERE is_public = true;

CREATE INDEX IF NOT EXISTS idx_scorm_scos_package ON scorm_scos(package_id);
CREATE INDEX IF NOT EXISTS idx_scorm_scos_order ON scorm_scos(package_id, seq_order);
CREATE INDEX IF NOT EXISTS idx_scorm_scos_parent ON scorm_scos(parent_id) WHERE parent_id IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_scorm_enrollments_user ON scorm_enrollments(user_id);
CREATE INDEX IF NOT EXISTS idx_scorm_enrollments_package ON scorm_enrollments(package_id);

CREATE INDEX IF NOT EXISTS idx_scorm_runtime_enrollment ON scorm_runtime(enrollment_id);
CREATE INDEX IF NOT EXISTS idx_scorm_runtime_sco ON scorm_runtime(sco_id);
CREATE INDEX IF NOT EXISTS idx_scorm_runtime_package ON scorm_runtime(package_id);
CREATE INDEX IF NOT EXISTS idx_scorm_runtime_status ON scorm_runtime(lesson_status, completion_status);

CREATE INDEX IF NOT EXISTS idx_scorm_interactions_runtime ON scorm_interactions(runtime_id);
CREATE INDEX IF NOT EXISTS idx_scorm_objectives_runtime ON scorm_objectives(runtime_id);

CREATE INDEX IF NOT EXISTS idx_scorm_analytics_user ON scorm_analytics(user_id);
CREATE INDEX IF NOT EXISTS idx_scorm_analytics_package ON scorm_analytics(package_id);
CREATE INDEX IF NOT EXISTS idx_scorm_analytics_event ON scorm_analytics(event_type);
CREATE INDEX IF NOT EXISTS idx_scorm_analytics_timestamp ON scorm_analytics(timestamp);

CREATE INDEX IF NOT EXISTS idx_scorm_logs_user ON scorm_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_scorm_logs_package ON scorm_logs(package_id);
CREATE INDEX IF NOT EXISTS idx_scorm_logs_level ON scorm_logs(level);
CREATE INDEX IF NOT EXISTS idx_scorm_logs_created ON scorm_logs(created_at);
