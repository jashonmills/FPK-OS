-- Create native courses system tables
...
CREATE TRIGGER update_native_courses_updated_at BEFORE UPDATE ON public.native_courses FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
INSERT INTO public.native_courses (title, slug, summary, est_minutes, cover_url, visibility, created_by) VALUES (
