...
serve(async (req) => {
  ...
  try {
    ...
    const targetUrls = [
      ...
      {
        url: "https://sites.ed.gov/idea/regs/b",
        title: "IDEA Part B Regulations",
      },
      {
        url: "https://sites.ed.gov/idea/regs/c",
        title: "IDEA Part C Regulations",
      },
    ];

    console.log("Starting IDEA content scraping...");
      ...
      try {
        ...
        const { data: kbEntry, error: kbError } = await supabase
          ...
          .insert({
            ...
            focus_areas: ["special-education", "legal"],
    ...
    console.error("Error in scrape-idea-content:", error);
    return new Response(
