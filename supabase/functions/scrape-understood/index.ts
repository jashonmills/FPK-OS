...
const TARGET_URLS = [
  {
    url: "https://www.understood.org/en/articles/understanding-dyslexia",
    title: "Understanding Dyslexia"
  },
  {
    url: "https://www.understood.org/en/articles/understanding-dyscalculia",
    title: "Understanding Dyscalculia"
  },
  {
    url: "https://www.understood.org/en/articles/understanding-executive-functioning-issues",
    title: "Understanding Executive Function Issues"
  }
];
  ...
  try {
    ...
    for (const target of TARGET_URLS) {
      ...
      const { data: kbEntry, error: kbError } = await supabase
        .from("knowledge_base")
        .insert({
          source_name: "Understood.org",
          document_type: "educational_guide",
          title: target.title,
          source_url: target.url,
          focus_areas: ["learning-differences", "special-education"],
          keywords: ["learning differences", "dyslexia", "dyscalculia", "executive function"]
        })
        .select()
        .single();
    ...
    return new Response(
      JSON.stringify({
        message: "Understood.org scraping completed",
    ...
    console.error("Error in scrape-understood:", error);
    return new Response(
