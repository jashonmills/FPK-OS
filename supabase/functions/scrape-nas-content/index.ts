...
serve(async (req) => {
  ...
  try {
    ...
    const targetUrls = [
      ...
      {
        url: "https://www.autism.org.uk/advice-and-guidance/topics/communication/communication-help/all-audiences",
        title: "Communication and Interaction",
      },
    ];

    console.log("Starting NAS content scraping...");
    ...
    console.error("Error in scrape-nas-content:", error);
    return new Response(
