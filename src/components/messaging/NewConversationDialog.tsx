...
import { Search, Users, User, MessageSquare } from 'lucide-react';
import { useOrgMembersForMention, MentionableUser } from '@/hooks/useOrgMembersForMention';
...
export function NewConversationDialog({
  ...
  const { members, isLoading } = useOrgMembersForMention(orgId, searchQuery);
                ...
                {isLoading ? (
                  ...
                  members.map(member => (
                    ...
                    >
                      {activeTab === 'group' && (
                        <Checkbox 
                          checked={isUserSelected(member.id)}
