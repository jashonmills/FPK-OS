...
export const RaisingBookScreenLesson: React.FC = () => {
  return (
    <div className="space-y-6">
      <MediaPlayer
        src="https://zgcegkmqfgznbpdplscz.supabase.co/storage/v1/object/public/learning-state-course/ep-learning-v2/Module%209%20-%20Raising%20Up%20Book%20Screen.mp4"
        type="video"
