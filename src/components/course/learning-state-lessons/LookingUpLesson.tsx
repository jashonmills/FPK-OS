...
export const LookingUpLesson: React.FC = () => {
  return (
    <div className="space-y-6">
      <MediaPlayer
        src="https://zgcegkmqfgznbpdplscz.supabase.co/storage/v1/object/public/learning-state-course/Module-10-Learning%20State/Module%2010%20-%20Looking%20Up.mp4"
        type="video"
