...
export const BreathingLesson: React.FC = () => {
  return (
    <div className="space-y-6">
      <MediaPlayer
        src="https://zgcegkmqfgznbpdplscz.supabase.co/storage/v1/object/public/learning-state-course/Module-6-Learning%20State/Module%206%20-%20Box%20Breathing.mp4"
        type="video"
