      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 px-3 py-2 bg-muted rounded-md font-mono text-sm font-semibold break-all">
        ...
        <div className="text-xs text-muted-foreground">
          Share this code with friends to invite them to join FPK Nexus. They'll enter it during sign-up!
        </div>
      </div>
    </WidgetCard>
  );
