...
interface CoursesVideoModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function CoursesVideoModal({ isOpen, onClose }: CoursesVideoModalProps) {
        ...
        <div className="p-4">
          <AspectRatio ratio={16 / 9}>
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/aTzBu_VJ2gM?si=UcVUJGmUwbEbDGvy"
