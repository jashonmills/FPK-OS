...
export const StudentOverview = () => {
  ...
  if (!selectedStudent || !selectedFamily) return null;
  ...
  return (
    <div className="space-y-6">
      ...
      <TeamDiscussion 
        ...
        title="Student Notes & Discussion"
        placeholder="Share general observations, care updates, or discuss the student's overall needs..."
      />
    </div>
  );
};
