...
const LiveHubAPODCard: React.FC<LiveHubAPODCardProps> = ({ onLearnMore }) => {
  ...
  if (error) {
    return (
      <Card ref={elementRef} className="bg-gradient-to-br from-slate-800 to-blue-900 border-slate-700">
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-xs text-blue-200 mb-4">Failed to fetch astronomy content</p>
            <Button 
              variant="outline" 
              size="sm" 
              onClick={() => refetch()}
