...
const lessons: Lesson[] = [
  { id: 1, title: "The Scientific Method", component: ScientificMethodLesson, unit: "Unit 1: The Scientific Method", unitColor: "bg-blue-100 text-blue-700" },
  { id: 2, title: "The Importance of Science", component: ImportanceOfScienceLesson, unit: "Unit 1: The Scientific Method", unitColor: "bg-blue-100 text-blue-700" },
  { id: 3, title: "Cell Structure and Function", component: CellStructureLesson, unit: "Unit 2: Biology", unitColor: "bg-green-100 text-green-700" },
  { id: 4, title: "Genetics and DNA", component: GeneticsAndDNALesson, unit: "Unit 2: Biology", unitColor: "bg-green-100 text-green-700" },
  { id: 5, title: "Atoms and Molecules", component: AtomsAndMoleculesLesson, unit: "Unit 3: Chemistry", unitColor: "bg-red-100 text-red-700" },
  { id: 6, title: "The Periodic Table", component: PeriodicTableLesson, unit: "Unit 3: Chemistry", unitColor: "bg-red-100 text-red-700" },
  { id: 7, title: "Forces and Motion", component: ForcesAndMotionLesson, unit: "Unit 4: Physics", unitColor: "bg-yellow-100 text-yellow-700" },
  { id: 8, title: "Energy and Work", component: EnergyAndWorkLesson, unit: "Unit 4: Physics", unitColor: "bg-yellow-100 text-yellow-700" },
  { id: 9, title: "Review and Summary", component: ReviewAndSummaryLesson, unit: "Unit 5: Conclusion", unitColor: "bg-gray-100 text-gray-700" },
  { id: 10, title: "Further Exploration", component: FurtherExplorationLesson, unit: "Unit 5: Conclusion", unitColor: "bg-gray-100 text-gray-700" },
  { id: 11, title: "Short-Answer Questions", component: ShortAnswerQuestionsLesson, unit: "Unit 6: Study Guide", unitColor: "bg-purple-100 text-purple-700" },
  { id: 12, title: "Complete Study Guide", component: StudyGuideLesson, unit: "Unit 6: Study Guide", unitColor: "bg-purple-100 text-purple-700" }
];
