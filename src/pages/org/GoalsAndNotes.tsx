        ...
        <div className="flex items-start justify-between">
          ...
          {isStudent ? (
            <Button 
              variant="ghost" 
              size="sm" 
              className="border border-white/20 text-white hover:border-white/40 hover:bg-transparent"
              onClick={(e) => {
                e.stopPropagation();
                onView();
              }}
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className="border border-white/20 text-white hover:bg-transparent hover:border-white/40"
              onClick={(e) => {
                e.stopPropagation();
                onEdit();
              }}
