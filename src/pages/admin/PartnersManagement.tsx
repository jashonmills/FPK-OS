...
import { ArrowLeft, Plus, Pencil, Trash2, ExternalLink, Handshake } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Manage trusted partners and recommended tools displayed on the Resources page
            </p>
          </div>
        </div>
