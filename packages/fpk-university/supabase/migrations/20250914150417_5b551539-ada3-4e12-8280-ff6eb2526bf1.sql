...
-- First, create the quiz block using correct column names
INSERT INTO lesson_blocks (lesson_id, type, data_json, order_index, created_at, updated_at)
VALUES 
('ff2eae67-4334-4a7c-9a83-350de3c22cb5', 'quiz', '{"title": "Quiz: Behavioral Economics", "instructions": "Test your understanding of behavioral economics concepts and their real-world applications."}'::jsonb, 8, now(), now());
