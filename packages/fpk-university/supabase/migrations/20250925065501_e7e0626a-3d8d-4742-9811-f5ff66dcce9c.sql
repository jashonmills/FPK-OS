-- Fix the SQL function to work with actual table structure
...
-- Change instructors to students temporarily to show test data
...
-- Add ONE study session with recent activity for first student (will show as 'active')
...
VALUES 
  ('2994c049-3a25-4633-98da-cbfe61157416', 'memory_test', ARRAY[]::uuid[], 0, 1800, 0, 0, now() - interval '10 minutes', now() - interval '5 minutes')
ON CONFLICT DO NOTHING;

-- Add basic enrollment 
