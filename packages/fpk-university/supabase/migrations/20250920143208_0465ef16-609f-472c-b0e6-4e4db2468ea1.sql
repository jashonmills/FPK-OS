-- Fix the get_organization_statistics function to remove reference to non-existent completion_percentage column
...
BEGIN
  ...
  -- Get course completion data from enrollments (using existing columns)
  SELECT 
  ...
  -- Get average progress across all enrollments in the org (using existing progress column)
