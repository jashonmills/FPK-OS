  ...
  public: {
    Tables: {
      active_time_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "active_time_sessions_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "active_time_sessions_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      file_document_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "file_document_links_file_id_fkey"
            columns: ["file_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "file_document_links_page_id_fkey"
            columns: ["page_id"]
            isOneToOne: false
            referencedRelation: "doc_pages"
            referencedColumns: ["id"]
